...
public class EnumerableConversionTests
{
    ...
    {
        // 준비
        IEnumerable<int> source = Enumerable.Range(1, 5).Where(x => x % 2 == 0);
    ...
    {
        // 준비
        string[] source = new[] { "apple", "apricot" }; // 둘 다 'a'로 시작
    ...
    public void Cast_이미_올바른_형식이면_그대로_반환()
    {
        ...
        // 실행
        IEnumerable<int> result = source.Cast<int>();
    ...
    public void Cast_잘못된_형식_예외_발생()
    {
        ...
        // 실행 - 열거 시 예외 발생
        IEnumerable<int> query = source.Cast<int>();
    ...
    {
        // 실행
        IEnumerable<string> empty1 = Enumerable.Empty<string>();
