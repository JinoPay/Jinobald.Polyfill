...
public class EnumerableBasicTests
{
    ...
    {
        // 준비
        string[] source = new[] { "Apple", "Banana", "Cherry" };
    ...
    public void FirstOrDefault_조건을_만족하는_요소_없음_기본값_반환()
    {
        ...
        // 실행
        int result = source.FirstOrDefault(x => x > 10);
    ...
    public void LastOrDefault_마지막_요소_반환()
    {
        ...
        // 실행
        int result = source.LastOrDefault();
    ...
    public void Select_지연_실행_확인()
    {
        ...
        // 실행 - 쿼리 정의
        IEnumerable<int> query = new[] { 1, 2, 3 }.Select(x =>
        {
            transformCount++;
            return x * 2;
        });
    ...
    public void SelectMany_결과_선택기_사용()
    {
        ...
        var source = new[]
        {
            new { Name = "Alice", Pets = new[] { "Cat", "Dog" } }, new { Name = "Bob", Pets = new[] { "Bird" } }
        };
    ...
    {
        // 준비
        int[][] source = new[] { new[] { 1, 2 }, new[] { 3, 4 } };
    ...
    public void SingleOrDefault_빈_시퀀스_기본값_반환()
    {
        ...
        // 실행
        int result = source.SingleOrDefault();
