...
public class EnumerableAggregateTests
{
    ...
    public void Aggregate_시드값사용_초기값포함()
    {
        ...
        int result = source.Aggregate(10, (acc, x) => acc + x);
    ...
    {
        string[] source = new[] { "a", "b", "c", "d" };

        string? result = source.Aggregate((current, next) => current + next);
    ...
    {
        string[] source = new[] { "a", "bb", "ccc", "dddd" };

        double result = source.Average(s => s.Length);
    ...
    {
        decimal[] source = new[] { 1.0m, 2.0m, 3.0m };

        decimal result = source.Average();
    ...
    {
        int?[] source = new int?[] { 1, null, 2, null, 3 };
    ...
    {
        string[] source = new[] { "aaa", "b", "cc" };

        int result = source.Max(s => s.Length);
    ...
    {
        string[] source = new[] { "banana", "apple", "cherry" };

        string? result = source.Max();
    ...
    {
        double[] source = new[] { 3.5, 1.2, 4.8 };

        double result = source.Max();
    ...
    {
        int?[] source = new int?[] { 5, null, 2, null, 8 };
    ...
    public void Min_선택기_투영값최소()
    {
        ...
        int result = source.Min(s => s.Length);
    ...
    {
        decimal[] source = new[] { 1.1m, 2.2m, 3.3m };
