...
public sealed class HttpRequestHeaders : HttpHeaders
{
    ...
    {
        get => TryGetValues("Accept", out var values) ? string.Join(", ", ((List<string>)values!).ToArray()) : null;
        set
        {
            Remove("Accept");
            if (value != null)
    ...
    {
        get => TryGetValues("Authorization", out var values) ? string.Join(", ", ((List<string>)values!).ToArray()) : null;
        set
        {
    ...
    {
        get => TryGetValues("User-Agent", out var values) ? string.Join(" ", ((List<string>)values!).ToArray()) : null;
        set
        {
            Remove("User-Agent");
            if (value != null)
    ...
    public string? Host
    {
        get => TryGetValues("Host", out var values) ? string.Join(", ", ((List<string>)values!).ToArray()) : null;
        set
        {
            Remove("Host");
            if (value != null)
...
public sealed class HttpResponseHeaders : HttpHeaders
{
    ...
    {
        get => TryGetValues("Server", out var values) ? string.Join(" ", ((List<string>)values!).ToArray()) : null;
        set
        {
            Remove("Server");
            if (value != null)
    ...
    public Uri? Location
    {
        get
        {
            if (TryGetValues("Location", out var values))
            {
                var locationValue = string.Join(", ", ((List<string>)values!).ToArray());
                if (Uri.TryCreate(locationValue, UriKind.RelativeOrAbsolute, out var uri))
                    return uri;
            }
            return null;
        }
...
public sealed class HttpContentHeaders : HttpHeaders
{
    ...
    {
        get => TryGetValues("Content-Type", out var values) ? string.Join(", ", ((List<string>)values!).ToArray()) : null;
        set
        {
            Remove("Content-Type");
            if (value != null)
    ...
    public long? ContentLength
    {
        get
        {
            ...
            {
                var lengthValue = string.Join("", ((List<string>)values!).ToArray());
                if (long.TryParse(lengthValue, out var length))
                    return length;
            }
            return null;
        }
    ...
    {
        get => TryGetValues("Content-Encoding", out var values) ? string.Join(", ", ((List<string>)values!).ToArray()) : null;
        set
        {
    ...
    {
        get => TryGetValues("Content-Disposition", out var values) ? string.Join(", ", ((List<string>)values!).ToArray()) : null;
        set
        {
