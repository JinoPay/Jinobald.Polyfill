...
public interface IStructuralComparable
{
    ...
    /// <returns>An integer that indicates the relationship of the current object to other, as shown in the following table.
    /// Value Meaning
    ...
    /// 1 The current instance comes after other in the sort order.</returns>
