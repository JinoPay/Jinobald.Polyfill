...
[DebuggerNonUserCode]
public static partial class XElementEx
{
    extension(XElement)
    {
        /// <summary>
        ...
        /// <summary>
        /// Asynchronously creates a new XElement and initializes its underlying XML tree using the specified XmlReader, optionally preserving white space.
        /// </summary>
