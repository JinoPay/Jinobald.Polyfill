...
public class Tuple<T1>(T1 item1) : IStructuralEquatable, IStructuralComparable, IComparable
{
    ...
    private int CompareTo(object? other, IComparer comparer)
    {
        ...
        if (other is not Tuple<T1> tuple) throw new ArgumentException(string.Empty, nameof(other));
...
public class Tuple<T1, T2>(T1 item1, T2 item2) : IStructuralEquatable, IStructuralComparable, IComparable
{
    ...
    private int CompareTo(object? other, IComparer comparer)
    {
        ...
        if (other is not Tuple<T1, T2> tuple) throw new ArgumentException(string.Empty, nameof(other));

        var result = comparer.Compare(Item1, tuple.Item1);
        if (result == 0) result = comparer.Compare(Item2, tuple.Item2);
...
public class Tuple<T1, T2, T3>(T1 item1, T2 item2, T3 item3) : IStructuralEquatable, IStructuralComparable, IComparable
{
    ...
    private int CompareTo(object? other, IComparer comparer)
    {
        ...
        if (other is not Tuple<T1, T2, T3> tuple) throw new ArgumentException(string.Empty, nameof(other));

        var result = comparer.Compare(Item1, tuple.Item1);
        if (result == 0) result = comparer.Compare(Item2, tuple.Item2);

        if (result == 0) result = comparer.Compare(Item3, tuple.Item3);
    ...
    : IStructuralEquatable, IStructuralComparable, IComparable
{
    ...
    private int CompareTo(object? other, IComparer comparer)
    {
        ...
        if (other is not Tuple<T1, T2, T3, T4> tuple) throw new ArgumentException(string.Empty, nameof(other));
        ...
        if (result == 0) result = comparer.Compare(Item4, tuple.Item4);
    ...
    : IStructuralEquatable, IStructuralComparable, IComparable
{
    ...
    public override string ToString()
    {
        return string.Format(CultureInfo.InvariantCulture, "({0}, {1}, {2}, {3}, {4})", Item1, Item2, Item3, Item4,
            Item5);
    }
    ...
    private int CompareTo(object? other, IComparer comparer)
    {
        ...
        if (other is not Tuple<T1, T2, T3, T4, T5> tuple) throw new ArgumentException(string.Empty, nameof(other));
        ...
        if (result == 0) result = comparer.Compare(Item5, tuple.Item5);
    ...
    : IStructuralEquatable, IStructuralComparable, IComparable
{
    ...
    public override string ToString()
    {
        return string.Format(CultureInfo.InvariantCulture, "({0}, {1}, {2}, {3}, {4}, {5})", Item1, Item2, Item3,
            Item4, Item5, Item6);
    }
    ...
    private int CompareTo(object? other, IComparer comparer)
    {
        ...
        if (result == 0) result = comparer.Compare(Item6, tuple.Item6);
    ...
    : IStructuralEquatable, IStructuralComparable, IComparable
{
    ...
    public override string ToString()
    {
        return string.Format(CultureInfo.InvariantCulture, "({0}, {1}, {2}, {3}, {4}, {5}, {6})", Item1, Item2,
    ...
    private int CompareTo(object? other, IComparer comparer)
    {
        ...
        if (result == 0) result = comparer.Compare(Item7, tuple.Item7);
...
public class Tuple<T1, T2, T3, T4, T5, T6, T7, TRest> : IStructuralEquatable, IStructuralComparable, IComparable
{
    ...
    public override string ToString()
    {
        ...
        return string.Format(CultureInfo.InvariantCulture, "({0}, {1}, {2}, {3}, {4}, {5}, {6}, {7})", Item1, Item2,
            Item3, Item4, Item5, Item6, Item7, restString.Substring(1, restString.Length - 2));
    }
