        ...
        ITupleInternal
{
    ...
    public static ValueTuple<T1, T2, T3, T4, T5> Create<T1, T2, T3, T4, T5>(T1 item1, T2 item2, T3 item3, T4 item4,
        T5 item5)
    {
    ...
    public static ValueTuple<T1, T2, T3, T4, T5, T6> Create<T1, T2, T3, T4, T5, T6>(T1 item1, T2 item2, T3 item3,
    ...
    public static ValueTuple<T1, T2, T3, T4, T5, T6, T7> Create<T1, T2, T3, T4, T5, T6, T7>(T1 item1, T2 item2,
    ...
    int IComparable.CompareTo(object? obj)
    {
        ...
        if (obj is not ValueTuple)
            throw new ArgumentException("The parameter should be a ValueTuple type of appropriate arity.",
                nameof(obj));
    ...
    /// <summary>
    ///     Returns a value that indicates whether the current <see cref="ValueTuple" /> instance is equal to a specified
    ///     object.
    /// </summary>
...
public struct ValueTuple<T1>
    : IEquatable<ValueTuple<T1>>, IStructuralEquatable, IStructuralComparable, IComparable,
        IComparable<ValueTuple<T1>>, ITupleInternal
{
    ...
    ///         <item>
    ///             <description>
    ///                 Its components are equal to those of the current instance. Equality is determined by the
    ///                 default object equality comparer for each component.
    ///             </description>
    ///         </item>
    ///     </list>
    /// </remarks>
    ...
    {
        if (other is ValueTuple<T1> valueTuple) return comparer.Equals(Item1, valueTuple.Item1);
        ...
        IComparable<ValueTuple<T1, T2>>, ITupleInternal
{
    ...
    public readonly int CompareTo(ValueTuple<T1, T2> other)
    {
        ...
        if (result == 0) result = Comparer<T2>.Default.Compare(Item2, other.Item2);

        return result;
    }

    /// <summary>
    ///     Returns a value that indicates whether the current <see cref="ValueTuple{T1, T2}" /> instance is equal to a
    ///     specified object.
    /// </summary>
    /// <param name="obj">The object to compare with this instance.</param>
    /// <returns>
    ...
    /// <summary>
    ///     Returns a value that indicates whether the current <see cref="ValueTuple{T1, T2}" /> instance is equal to a
    ///     specified <see cref="ValueTuple{T1, T2}" />.
    /// </summary>
    /// <param name="other">The tuple to compare with this instance.</param>
    /// <returns>
    ///     <see langword="true" /> if the current instance is equal to the specified tuple; otherwise,
    ...
    readonly int IStructuralComparable.CompareTo(object? other, IComparer comparer)
    {
        ...
        if (result == 0) result = comparer.Compare(Item2, valueTuple.Item2);
    ...
    ///         first passes the <see cref="Item1" /> values of the <see cref="ValueTuple{T1, T2}" /> objects to be compared to
    ///         the
        ...
        IComparable<ValueTuple<T1, T2, T3>>, ITupleInternal
{
    ...
    public readonly int CompareTo(ValueTuple<T1, T2, T3> other)
    {
        ...
        if (result == 0) result = Comparer<T3>.Default.Compare(Item3, other.Item3);
    ...
    {
        return
            $"({Item1?.ToString() ?? string.Empty}, {Item2?.ToString() ?? string.Empty}, {Item3?.ToString() ?? string.Empty})";
    }
    ...
    readonly int IStructuralComparable.CompareTo(object? other, IComparer comparer)
    {
        ...
        if (result == 0) result = comparer.Compare(Item3, valueTuple.Item3);
        ...
        IComparable<ValueTuple<T1, T2, T3, T4>>, ITupleInternal
{
    ...
    public readonly int CompareTo(ValueTuple<T1, T2, T3, T4> other)
    {
        ...
        if (result == 0) result = Comparer<T4>.Default.Compare(Item4, other.Item4);
    ...
    {
        return
            $"({Item1?.ToString() ?? string.Empty}, {Item2?.ToString() ?? string.Empty}, {Item3?.ToString() ?? string.Empty}, {Item4?.ToString() ?? string.Empty})";
    }
    ...
    readonly int IStructuralComparable.CompareTo(object? other, IComparer comparer)
    {
        ...
        if (result == 0) result = comparer.Compare(Item4, valueTuple.Item4);
        ...
        IComparable<ValueTuple<T1, T2, T3, T4, T5>>, ITupleInternal
{
    ...
    public readonly int CompareTo(ValueTuple<T1, T2, T3, T4, T5> other)
    {
        ...
        if (result == 0) result = Comparer<T5>.Default.Compare(Item5, other.Item5);

        return result;
    }

    /// <summary>
    ///     Returns a value that indicates whether the current <see cref="ValueTuple{T1, T2, T3, T4, T5}" /> instance is equal
    ...
    {
        return
            $"({Item1?.ToString() ?? string.Empty}, {Item2?.ToString() ?? string.Empty}, {Item3?.ToString() ?? string.Empty}, {Item4?.ToString() ?? string.Empty}, {Item5?.ToString() ?? string.Empty})";
    }
    ...
    readonly int IStructuralComparable.CompareTo(object? other, IComparer comparer)
    {
        ...
        if (result == 0) result = comparer.Compare(Item5, valueTuple.Item5);
        ...
        IComparable<ValueTuple<T1, T2, T3, T4, T5, T6>>, ITupleInternal
{
    ...
    public readonly int CompareTo(ValueTuple<T1, T2, T3, T4, T5, T6> other)
    {
        ...
        if (result == 0) result = Comparer<T6>.Default.Compare(Item6, other.Item6);
    ...
    {
        return
            $"({Item1?.ToString() ?? string.Empty}, {Item2?.ToString() ?? string.Empty}, {Item3?.ToString() ?? string.Empty}, {Item4?.ToString() ?? string.Empty}, {Item5?.ToString() ?? string.Empty}, {Item6?.ToString() ?? string.Empty})";
    }
    ...
    readonly int IStructuralComparable.CompareTo(object? other, IComparer comparer)
    {
        ...
        if (result == 0) result = comparer.Compare(Item6, valueTuple.Item6);
        ...
        IComparable<ValueTuple<T1, T2, T3, T4, T5, T6, T7>>, ITupleInternal
{
    ...
    public readonly int CompareTo(ValueTuple<T1, T2, T3, T4, T5, T6, T7> other)
    {
        ...
        if (result == 0) result = Comparer<T7>.Default.Compare(Item7, other.Item7);

        return result;
    }

    /// <summary>
    ///     Returns a value that indicates whether the current <see cref="ValueTuple{T1, T2, T3, T4, T5, T6, T7}" /> instance
    ...
    {
        return
            $"({Item1?.ToString() ?? string.Empty}, {Item2?.ToString() ?? string.Empty}, {Item3?.ToString() ?? string.Empty}, {Item4?.ToString() ?? string.Empty}, {Item5?.ToString() ?? string.Empty}, {Item6?.ToString() ?? string.Empty}, {Item7?.ToString() ?? string.Empty})";
    }
    ...
    readonly int IStructuralComparable.CompareTo(object? other, IComparer comparer)
    {
        ...
        if (result == 0) result = comparer.Compare(Item7, valueTuple.Item7);
...
public struct ValueTuple<T1, T2, T3, T4, T5, T6, T7, TRest>
    : IEquatable<ValueTuple<T1, T2, T3, T4, T5, T6, T7, TRest>>, IStructuralEquatable, IStructuralComparable,
    ...
    where TRest : struct
{
    ...
    public readonly int CompareTo(ValueTuple<T1, T2, T3, T4, T5, T6, T7, TRest> other)
    {
        ...
        if (result == 0) result = Comparer<TRest>.Default.Compare(Rest, other.Rest);
    ...
    {
        return
            $"({Item1?.ToString() ?? string.Empty}, {Item2?.ToString() ?? string.Empty}, {Item3?.ToString() ?? string.Empty}, {Item4?.ToString() ?? string.Empty}, {Item5?.ToString() ?? string.Empty}, {Item6?.ToString() ?? string.Empty}, {Item7?.ToString() ?? string.Empty}, {(Rest is ITupleInternal rest ? rest.ToStringEnd() : Rest + ")")}";
    }
    ...
    readonly int IComparable.CompareTo(object? obj)
    {
        ...
        if (obj is ValueTuple<T1, T2, T3, T4, T5, T6, T7, TRest> valueTuple) return CompareTo(valueTuple);
    ...
    readonly int IStructuralComparable.CompareTo(object? other, IComparer comparer)
    {
        ...
        if (result == 0) result = comparer.Compare(Rest, valueTuple.Rest);
