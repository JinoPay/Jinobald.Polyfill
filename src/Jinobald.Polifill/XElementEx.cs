...
internal static partial class Polyfill
{
    ...
    {
        /// <summary>
        ///     Asynchronously creates a new XElement and initializes its underlying XML tree using the specified stream,
        ///     optionally preserving white space.
        /// </summary>
        ...
        /// <summary>
        ///     Asynchronously creates a new XElement and initializes its underlying XML tree using the specified text reader,
        ///     optionally preserving white space.
        /// </summary>
        ...
        public static Task<XElement> LoadAsync(TextReader textReader, LoadOptions options,
        ...
        public static Task<XElement> LoadAsync(XmlReader reader, LoadOptions options,
            CancellationToken cancellationToken)
        {
            cancellationToken.ThrowIfCancellationRequested();
