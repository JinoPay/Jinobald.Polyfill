...
internal static partial class Polyfill
{
    ...
    public static void SetCanceled<T>(this TaskCompletionSource<T> target, CancellationToken cancellationToken)
    {
        if (target.TrySetCanceled(cancellationToken)) return;
